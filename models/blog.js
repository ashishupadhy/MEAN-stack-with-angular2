...
let titleLengthChecker = (title) => {
    if (!title) {
        ...
        if (titlr.length < 5 || title.length > 50) {
            return false;
        } else {
            return true;
        }
...
const titleValidators = [{
    ...
    message: 'title must be more than 5 character but not more than 50'
},
...
const bodyValidators = [

    {
        ...
        message: 'Body must be more than 5 character but not more than 500.'
    },
